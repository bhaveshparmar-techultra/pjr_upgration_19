...
class TestReportPy3o(TransactionCase):
    ...
    def test_reports_merge_pdf(self):
        ...
        for _i in range(0, 3):
            ...
            # PyPDF2 2.x+ uses add_page and create_blank_page
            # PyPDF2 1.x uses addPage and createBlankPage
            try:
                blank_page = PageObject.create_blank_page(width=100, height=100)
                writer.add_page(blank_page)
            except AttributeError:
                blank_page = PageObject.createBlankPage(width=100, height=100)
